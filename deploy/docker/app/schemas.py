...
from app.utils import FilterType
...
class ScreenshotRequest(BaseModel):
    url: str
    screenshot_wait_for: Optional[float] = Field(2.0, description="Delay before capture in seconds. Zero/negative values accepted (treated as immediate capture). Default: 2.0 seconds")
